...
export class LoopDetectionService {
    ...
    async checkForLoopWithLLM(signal) {
        ...
        const flashConfidence = typeof flashResult['unproductive_state_confidence'] === 'number'
            ? flashResult['unproductive_state_confidence']
            : 0;
        const flashAnalysis = typeof flashResult['unproductive_state_analysis'] === 'string'
