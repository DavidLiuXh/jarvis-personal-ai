...
import { BaseDeclarativeTool, BaseToolInvocation, ToolConfirmationOutcome, type ToolInvocation, type ToolResult, type ToolCallConfirmationDetails, type PolicyUpdateOptions, type ToolLiveOutput } from './tools.js';
...
export declare class ShellToolInvocation extends BaseToolInvocation<ShellToolParams, ToolResult> {
    ...
    execute(signal: AbortSignal, updateOutput?: (output: ToolLiveOutput) => void, shellExecutionConfig?: ShellExecutionConfig, setPidCallback?: (pid: number) => void): Promise<ToolResult>;
}
